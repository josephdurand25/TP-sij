<?php
    ...
    // require 'traitements/page2.php';
    include 'traitements/connection.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="min-h-screen flex items-center justify-center w-full dark:bg-gray-950">
	<div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md mtt4">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <span class="text-xl font-bold">
                    <?= !$conn->connect_error ? 'Connection réussi': 'Echec de la connection' ?>
                </span>
            </div>
        </div>
        <div class="mt-6">
            <h2 class="text-lg font-medium text-gray-700 dark:text-gray-2
		<h1 class="text-2xl font-bold text-center mb-4 dark:text-gray-200">Welcome to SIJ practical work 2!</h1>
		<form action="#">
			<div class="mb-4">
